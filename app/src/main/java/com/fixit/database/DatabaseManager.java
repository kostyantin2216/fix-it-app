...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(OrderDataDAO.CMD_CREATE_TABLE);
        db.execSQL(JobReasonDAO.CMD_CREATE_TABLE);
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL(DROP_TABLE + ProfessionDAO.TABLE_NAME);
        db.execSQL(DROP_TABLE + OrderDataDAO.TABLE_NAME);
        db.execSQL(DROP_TABLE + JobReasonDAO.TABLE_NAME);
